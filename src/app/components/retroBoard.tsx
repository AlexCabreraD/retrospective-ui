...
import {gatherAndSortPostsWithSectionTitle, scrollbarStyle } from "@/app/utils/helper";
...
export default function RetroBoard({
  ...
  return (
      <div
          className="w-full flex flex-col items-center px-4 sm:px-6 lg:flex-row lg:justify-center lg:items-start overflow-hidden">
        <Snackbar
            visible={showSnack}
        ...
        />
         ...
         <div
            className="flex flex-col bg-black text-white w-full lg:w-[80%] max-w-[1720px] h-full py-6 lg:py-16 mx-auto min-w-full lg:min-w-[1250px] ">
          ...
          >
           ...
           {reviewing &&<div className={"flex"}>
            ...
            >
              ...
              {gatherAndSortPostsWithSectionTitle(sections).map((postWithSectionTitle,index)=>(
                  <div>
                    <Card key={index} post={postWithSectionTitle.post} socket={socket} showLikeCountOnly/>
                  </div>
